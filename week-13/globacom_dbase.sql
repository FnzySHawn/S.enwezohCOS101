...
\restrict jmqha04O7lnU94GSBsK9PRkykVxIkbsggMJrLodAo7At6kNm2bfGh54raRrQ3Ha
...
CREATE TABLE public.dataplan (
    ...
    data_price numeric(10,2) NOT NULL
);
...
COPY public.customer (c_id, c_name, c_age, c_email, c_mobile, staff_id, data_id) FROM stdin;
...
--
-- Name: customer customer_staff_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.customer
    ADD CONSTRAINT customer_staff_id_fkey FOREIGN KEY (staff_id) REFERENCES public.staff(staff_id);
...
\unrestrict jmqha04O7lnU94GSBsK9PRkykVxIkbsggMJrLodAo7At6kNm2bfGh54raRrQ3Ha
